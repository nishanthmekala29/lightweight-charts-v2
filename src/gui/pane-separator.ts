...
export class PaneSeparator implements IDestroyable {
	...
	public constructor(chartWidget: IChartWidgetBase, topPaneIndex: number, bottomPaneIndex: number, disableResize: boolean, resizeDelegate: Delegate<PaneEventParamsImplSupplier>) {
